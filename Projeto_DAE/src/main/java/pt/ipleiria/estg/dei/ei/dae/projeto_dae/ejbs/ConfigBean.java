    ...
    public void populateDB(){
       System.out.println("Hello!!");
        ...
        try{
            ...
            PublicationCreateDTO dto2 = new PublicationCreateDTO();
            dto.setTitle("Segunda Publicação");
            dto.setDescription("Publicação ");
            dto.setArea("Software");
            dto.setAuthors(List.of("raquel"));
            dto.setTags(List.of("Science"));

            InputStream dummyFile2 =
                    new ByteArrayInputStream("conteudo fake".getBytes());

            publicationBean.create("file.txt", dummyFile2, dto2);
